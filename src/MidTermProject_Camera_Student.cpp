...
int main(int argc, const char *argv[])
{
    ...
    result.open("../res/res_roi.csv", std::fstream::out | std::fstream::app);

    // result << "detectorType" << "," << "descriptorType" << "," << "imgIndex" << "," << "detectorTime" << ","
        //    << "descriptorTime" << "," << "detectedROINum"  << "," << "matchedKpts" << "," <<"totalTime" << endl;
    // data location
    string dataPath = "../";
    ...
    for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex++)
    {
        ...
        {
            detKeypointsShiTomasi(keypoints, imgGray, detectorTime, false);
        }
        ...
        int detectedROINum = keypoints.size();
        ...
        result << detectorType << "," << descriptorType << "," << imgIndex << "," << detectorTime << ","
               << descriptorTime << "," << detectedROINum  << "," << matchedKpts << "," << detectorTime + descriptorTime << endl;
